...
from nxs.tui.formatters import sanitize_widget_id
from nxs.tui.widgets.artifact_item import ArtifactItem
...
from nxs.tui.widgets.static_no_margin import StaticNoMargin
