...
class ToolManager:
    @classmethod
    async def get_all_tools(cls, clients: dict[str, AuthClient]) -> list[Tool]:
    ...
    @classmethod
    async def _find_client_with_tool(cls, clients: list[AuthClient], tool_name: str) -> Optional[AuthClient]:
    ...
    @classmethod
    async def execute_tool_requests(cls, clients: dict[str, AuthClient], message: Message) -> List[ToolResultBlockParam]:
